                            ...
                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                <div class="flex justify-center relative">
                                    ...
                                    <form id="delete-form-{{ $comp->id }}"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="bg-red-600 px-2 py-2 rounded-lg" onclick="confirmDelete({{ $comp->id }})"><i class="fa-regular fa-circle-xmark" style="color: rgb(255, 255, 255);"></i></i></button>
                                    </form>
...
<script>
    ...
    function confirmDelete(id) {
        ...
        Swal.fire({
            ...
            confirmButtonText: isAdmin ? 'Ya, tolak!' : 'Ya, hapus!',
